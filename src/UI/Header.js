...
const Header = () => {
  return (
    ...
    <div className="bg-[#f9fafb]">
      <div className=" max-w-full bg-[#f9fafb] m-10 mr-5 ">
        <div className="bg-[#f9fafb] my-3 ">
          <div className="flex bg-[#f9fafb] py-8 px-6 md:flex-row ">
            <div className="flex flex-row bg-[#f9fafb] ">
              <button className="bg-[#ff00a6] rounded-lg p-2 ml-4 my-4  text-white font-bold hover:bg-[#ff33a6] flex">
                ورود یا عضویت
              </button>
              <a
                className="bg-[#f9fafb] text-[#3a3d42] text-sm ml-8 py-6 flex"
                href="#"
              >
                ثبت نام فروشندگان
              </a>
              <svg
                className=" flex w-6 ml-3"
                viewBox="0 0 24 26"
                fill="currentColor"
            ...
            <div className="flex">
              <img className="w-30 ml-[800px]" src={snapsvg}></img>
            </div>
          </div>
        </div>
        <div className="bg-[#f9fafb] max-w-full flex flex-row">
          <img className="z-10 absolute top-[120px]" src={banner}></img>
        </div>
      </div>
          ...
          <div className="rounded-full bg-white p-1 pl-2">
            <button>
                <div className="flex flex-row justify-center items-center">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="20" viewBox="0 0 12 14" fill="gray"><path fill-rule="evenodd" clip-rule="evenodd" d="M9.11216 9.2305C10.8115 7.50007 10.8115 4.7073 9.11216 2.97687C7.39661 1.22993 4.60338 1.22993 2.88783 2.97687C1.18849 4.7073 1.18849 7.50007 2.88783 9.2305L5.89303 12.2907C5.91798 12.3161 5.95396 12.3333 5.99999 12.3333C6.04603 12.3333 6.08201 12.3161 6.10696 12.2907L9.11216 9.2305ZM10.0069 10.1839C12.2199 7.93048 12.2199 4.27689 10.0069 2.02343C7.79396 -0.230038 4.20603 -0.230038 1.99306 2.02343C-0.219915 4.27689 -0.219915 7.93048 1.99306 10.1839L4.99826 13.2441C5.5515 13.8075 6.44849 13.8075 7.00173 13.2441L10.0069 10.1839Z" fill="var(--sf-inactive-dark)"/><path fill-rule="evenodd" clip-rule="evenodd" d="M5.99999 4.89127C5.29867 4.89127 4.77999 5.46244 4.77999 6.10368C4.77999 6.74492 5.29867 7.3161 5.99999 7.3161C6.70132 7.3161 7.22 6.74492 7.22 6.10368C7.22 5.46244 6.70132 4.89127 5.99999 4.89127ZM5.99999 3.55794C4.61928 3.55794 3.49999 4.69771 3.49999 6.10368C3.49999 7.50966 4.61928 8.64943 5.99999 8.64943C7.38071 8.64943 8.5 7.50966 8.5 6.10368C8.5 4.69771 7.38071 3.55794 5.99999 3.55794Z" fill="var(--sf-inactive-dark)"/></svg>
                </div>
            </button>
          </div>
        </div>
