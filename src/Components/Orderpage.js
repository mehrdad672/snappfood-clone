...
import KababCategori from "./kabab";
...
const Orderpage = () => {
  ...
  const orderlist = orderitems.map((i) => (
    <li className='list-none' key={i.id}>
      <OrderItem midi={i} />
    </li>
  ));
  console.log(orderlist)
  const totalAmount = orderitems.reduce((curNumber, item) => {
    return curNumber + item.amount;
  }, 0);

  const totalprice = orderitems.reduce((curNumber, item) => {
        ...
        <div className="hidden md:hidden lg:w-[25vw] lg:block h-screen px-4 overflow-auto scrollbar-hide ">
          ...
          <div className="bg-white rounded-lg w-full ">
            <div className="flex flex-row justify-between items-center px-2 pt-3">
              ...
              <h1 className=""> ({totalAmount})سبد خرید </h1>
            </div>
            {orderlist}
            ...
            <textarea
              ...
              className="text-right text-lg p-2 focus: outline-none focus:border-red-300 ml-8 mt-3 w-[250px] h-[100px] rounded-lg border border-gray-400"
            ></textarea>
          </div>
        </div>
        ...
        <div className="lg:w-[25vw] md:w-[50vw] w-[100vw] mb-4 px-2 h-1/2 md:h-screen ">
          <div className="flex justify-end items-center space-x-3">
            <div className="flex flex-col items-end space-y-3">
              ...
              <h1 className="font-bold text-xl">تهیه غذای مهرداد</h1>
            </div>
